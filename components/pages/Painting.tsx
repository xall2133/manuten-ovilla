...
export const Painting = () => {
  ...
  const getCriticalityColor = (crit: string) => {
    switch(crit) {
        case 'Alta': return 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300 border-red-200 dark:border-red-800';
        case 'Média': return 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300 border-amber-200 dark:border-amber-800';
