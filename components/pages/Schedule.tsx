...
export const Schedule = () => {
  ...
  // State apenas para o item de Terceiros/Obras
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
           ...
           <p className="text-slate-500 dark:text-slate-400">Gestão de contratos, manutenções terceirizadas e obras</p>
        </div>
                ...
                <div className="p-6 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center sticky top-0 bg-white dark:bg-slate-800 z-10">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-bold text-lg text-slate-800 dark:text-white">
                            {editingItem.id ? 'Editar Cronograma' : 'Novo Item do Cronograma'}
                        </h3>
                    </div>
